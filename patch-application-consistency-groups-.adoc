...
api: true
explorer: false
permalink: 'patch-application-consistency-groups-.html'
summary: 'Update a consistency group'
---

= Update a consistency group

[.api-doc-operation .api-doc-operation-patch]#PATCH# [.api-doc-code-block]#`/application/consistency-groups/{uuid}`#
