...
NOTE: this will not delete any associated volumes or LUNs. To remove those elements, you can use the appropriate object endpoint.
...
|query
|False
a|Delete the underlying storage as well as the consistency group association.
