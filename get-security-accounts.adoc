...
|query
|False
a|Filter by ssl_ca_certificate
...
|query
|False
a|Filter by authentication_methods
...
|ssl_ca_certificate
|string
a|SSL certificate for the chain of certificate authorities (CA) that have signed this user's client certificate.
