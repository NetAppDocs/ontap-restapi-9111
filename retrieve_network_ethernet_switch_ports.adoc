...
# The call:
curl -X GET "https://<mgmt-ip>/api/network/ethernet/switch/ports?fields=*" -H  "accept: application/json" -H  "Content-Type: application/hal+json"
...
# The call:
curl -X GET "https://<mgmt-ip>/api/network/ethernet/switch/ports/RTP-SS02-510R10%28FOC22131U6T%29/Ethernet1%2F9/436211712" -H  "accept: application/json" -H  "Content-Type: application/hal+json"
